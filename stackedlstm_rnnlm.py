...
def train_iters(iters, vocab_dict, hidden_size, lr, norm_clipping, num_layers):
    # load data
    sents_id = get_sent_id('data/trn-wiki.txt', vocab_dict)
    
    # build model
    rnn = StackedRNN(vocab_size=len(vocab_dict.keys()), hidden_size=hidden_size, 
...
if __name__=='__main__':
    ...
    rnn = train_iters(int(args.iters), vocab_dict, hidden_size, lr, norm_clipping, int(args.num_layers))
