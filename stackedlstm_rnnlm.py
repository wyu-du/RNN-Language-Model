...
class StackedRNN(nn.Module):
    ...
    def forward(self, input_token, hidden_state):
        ...
        out_last = out[self.num_layers-1, :, :]    # (1, 1, vocab_size)
...
def train_iters(iters, vocab_dict, hidden_size, num_layers, lr, norm_clipping):
    ...
    }, os.path.join(directory, '{}_{}.tar'.format(iters, 'checkpoint_stack')))
...
if __name__=='__main__':
    ...
    rnn = train_iters(int(args.iters), vocab_dict, hidden_size, int(args.num_layers), lr, norm_clipping)